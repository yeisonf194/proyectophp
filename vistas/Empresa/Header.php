    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="Index.php">Eventos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger mr-5" href="Index.php">Servicios</a>
          </li>
          <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="../Usuario/Registro.php"><span class="hidden-xs"><?php echo $_SESSION["tipo"]?></span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="../../Modelos/Registrar.php?op=salirEmpresa">Cerrar Sesion</a>
          </li>
        </ul>
      </div>
    </div>
