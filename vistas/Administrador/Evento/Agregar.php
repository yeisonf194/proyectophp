...
<div class="container">
    <div class="row d-flex">
        ...
        <div class="col-6 justify-aling-center">
            <form method="POST" action="../../../Modelos/Admin.php?op=agregarEvento" style="background-color: rgba(0,0,0,0.1); border-radius:20px; padding: 40px; width:100%; margin-left:280px">
                <div class="row d-flex">
